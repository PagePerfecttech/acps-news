  ...
  return (
    <div>
      ...
      <div className="flex border-b border-gray-200 mb-6">
        <button
          className={`py-2 px-4 font-medium ${activeTab === 'articles'
        ...
        <button
          className={`py-2 px-4 font-medium ${activeTab === 'ads'
              ? 'border-b-2 border-yellow-500 text-yellow-600'
              : 'text-gray-500 hover:text-gray-700'
            }`}
        ...
        <button
          className={`py-2 px-4 font-medium ${activeTab === 'comments'
              ? 'border-b-2 border-yellow-500 text-yellow-600'
              : 'text-gray-500 hover:text-gray-700'
            }`}
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {ads.map((ad) => (
                      <tr key={ad.id}>
                        ...
                        <td className="px-4 py-2 whitespace-nowrap">
                          <span
                            className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${ad.active
                                ? 'bg-green-100 text-green-800'
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {allComments.map((comment) => (
                      <tr key={comment.id}>
                        ...
                        <td className="px-4 py-2 whitespace-nowrap">
                          <span
                            className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${comment.approved
                                ? 'bg-green-100 text-green-800'
